...
namespace bosqmode.libvlc
{
    public class VLCPlayer : IDisposable
    {
        ...
        public VLCPlayer(int width, int height, string mediaUrl, bool audio)
        {
            ...
            LibVLCWrapper.libvlc_media_add_option(_media, ":network-caching=10");
            LibVLCWrapper.libvlc_media_add_option(_media, ":file-caching=10");
            // LibVLCWrapper.libvlc_media_add_option(_media, ":clock-jitter=0");
            // LibVLCWrapper.libvlc_media_add_option(_media, ":clock-synchro=0");
        ...
        private void TrackReaderThread()
        {
            ...
            {
                Debug.Log("Maximum attempts of getting video track reached, maybe opening failed?");
            }
        }
