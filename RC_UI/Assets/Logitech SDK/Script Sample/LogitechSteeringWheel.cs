...
public class LogitechSteeringWheel : MonoBehaviour
{
    ...
    public int overallGain = 80;
    public int springGain = 80;
    public int damperGain = 80;
    ...
    void Update()
    {
        ...
        if (LogitechGSDK.LogiUpdate() && LogitechGSDK.LogiIsConnected(0))
        {
            ...
            actualState += "wheel-axis position :" + rec.lX + "\n";
            ...
            if (Input.GetKeyUp(KeyCode.PageUp))
            {
                ...
                if (LogitechGSDK.LogiSetPreferredControllerProperties(properties)){
                    Debug.Log("LogiSet success!");
                }else {
                    Debug.Log("LogiSet fail!");
                }
