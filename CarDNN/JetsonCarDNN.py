...
class CarDNN(nn.Module):
    INPUT_SIZE_1 = 13
    OUTPUT_SIZE_1 = 3 + 6  # Predict the translation and the velocity

    INPUT_SIZE_2 = 10  # The input without the acceleration
    OUTPUT_SIZE_2 = 3  # Predict the linear acceleration

    def __init__(self):
        super(CarDNN, self).__init__()
        self.fc1 = nn.Linear(self.INPUT_SIZE_1, 64)
        self.fc2 = nn.Linear(64, 128)
        self.fc3 = nn.Linear(128, 256)
        self.fc4 = nn.Linear(256, 64)
        self.fc5 = nn.Linear(64, self.OUTPUT_SIZE_1)
        ...
        self.fc1_2 = nn.Linear(self.INPUT_SIZE_2, 64)
        self.fc2_2 = nn.Linear(64, 128)
        self.fc3_2 = nn.Linear(128, 64)
        self.fc4_2 = nn.Linear(64, self.OUTPUT_SIZE_2)
